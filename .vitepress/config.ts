...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'Organization',
      '@id': 'https://playground.wickra.org/#organization',
      name: 'Wickra',
      url: 'https://playground.wickra.org/',
      logo: 'https://playground.wickra.org/wickra-mark.svg',
      sameAs: [
        'https://github.com/wickra-lib/wickra-playground',
    ...
    },
    {
      ...
      '@id': 'https://playground.wickra.org/#software',
      ...
      description:
        'A polyglot strategy playground: one StrategySpec run live and side by side in Rust, JS, Go and Python, entirely in the browser over WebAssembly.',
      license: 'https://github.com/wickra-lib/wickra-playground#license',
      publisher: { '@id': 'https://playground.wickra.org/#organization' },
    },
  ],
}

export default defineConfig({
  title: 'Wickra Playground',
  description:
    'A polyglot strategy playground: one StrategySpec run live and side by side in Rust, JS, Go and Python, entirely in the browser over WebAssembly.',
  lang: 'en-US',
  cleanUrls: true,

  // Served at the domain root (playground.wickra.org via Cloudflare Pages).
  base: '/',

  sitemap: { hostname: 'https://playground.wickra.org' },
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Wickra Playground — one strategy spec, four languages, live in the browser' }],
    [
      'meta',
      {
    ...
    ['meta', { property: 'og:image', content: 'https://playground.wickra.org/og-banner.webp' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://playground.wickra.org/og-banner.webp' }],
    ['script', { type: 'application/ld+json' }, JSON.stringify(structuredData)],
  ],

  transformPageData(pageData) {
    const path = pageData.relativePath.replace(/(?:index)?\.md$/, '')
    const canonical = `https://playground.wickra.org/${path}`
  ...
  themeConfig: {
    siteTitle: 'Wickra Playground',
    logo: { src: '/wickra-mark.svg', alt: 'Wickra Playground' },
    logoLink: 'https://wickra.org/',

    nav: [
      { text: 'Home', link: '/' },
      { text: 'About', link: '/about' },
      { text: 'GitHub', link: 'https://github.com/wickra-lib/wickra-playground' },
      {
        text: 'Ecosystem',
        items: [
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/wickra-lib/wickra-playground' }],
